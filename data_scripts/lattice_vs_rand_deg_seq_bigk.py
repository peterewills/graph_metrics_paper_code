# same as lattice_vs_rand_deg_seq_lambda_k.py, but for larger values of k
...
file_name = 'lattice_vs_randDS_bigk.p'
path = os.path.join(data_dir,file_name)
tag = 1
while os.path.isfile(path):
    file_name = 'lattice_vs_randDS_bigk_{:02d}.p'.format(tag)
    path = os.path.join(data_dir,file_name)
    tag += 1
